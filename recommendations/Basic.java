...
public final class Basic {
    ...
    /**
     * Intoarce primul video nevazut de user din baza de date
     * @param action
     * @param movies
     * @param serials
     * @param users
    ...
    /**
     * Intoarce primul video cu cel mai bun rating din baza de date care nu
     * a fost vazut de user.
     * @param action
     * @param movies
     * @param serials
     * @param users
    ...
    public static JSONObject bestUnseen(final ActionInputData action,
        ...
        for (Movie movie : movies) {
             if (movie.getRatingGrade() > maxRating
        ...
        for (Serial serial : serials) {
            if (serial.getRatingGrade() > maxRating
